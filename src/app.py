...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and lap swims to build endurance and technique",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions with hands-on experiments and study sessions",
